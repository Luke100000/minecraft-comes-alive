...
> [!WARNING]
> Make sure to ***__BACKUP__*** your world.
> 
> This is an experimental beta release and most likely might contain bugs. Current building blueprint layout structures
> might not work properly, so you may have to press REMOVE BUILDING due to a new structure format
...
* Fixed MCA Editor Libraries rotations not being ticked
