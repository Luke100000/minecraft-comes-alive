...
import net.mca.network.c2s.CustomSkinListRequest;
import net.mca.resources.BuiltInSkinCatalog;
...
public final class ClientSkinCatalog {
    ...
    public static void installLegacyServerDelta(HashMap<String, Clothing> clothing, HashMap<String, Hair> hair) {
    ...
    public static void sync() {
        if (customSkinsOutdated) {
            NetworkHandler.sendToServer(new CustomSkinListRequest());
