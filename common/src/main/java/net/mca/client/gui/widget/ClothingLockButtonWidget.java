...
public class ClothingLockButtonWidget extends ButtonWidget {
    ...
    private static final ResourceLocation LOCKED_TEXTURE = MCA.locate("textures/gui/widget/locked_button.png");
    private static final ResourceLocation LOCKED_HIGHLIGHTED_TEXTURE = MCA.locate("textures/gui/widget/locked_button_highlighted.png");
    private static final ResourceLocation UNLOCKED_TEXTURE = MCA.locate("textures/gui/widget/unlocked_button.png");
    private static final ResourceLocation UNLOCKED_HIGHLIGHTED_TEXTURE = MCA.locate("textures/gui/widget/unlocked_button_highlighted.png");
