...
public class SpeechManager {
    ...
    public void stopPreview(VillagerEntityMCA villager) {
        EntityTrackingSoundInstance sound = currentlyPlaying.remove(villager.getUuid());
        if (sound != null) {
    ...
    private boolean hasVoicePackSounds() {
        return client.getSoundManager().getKeys().stream().anyMatch(sound -> sound.getNamespace().equals("mca_voices"));
    }
