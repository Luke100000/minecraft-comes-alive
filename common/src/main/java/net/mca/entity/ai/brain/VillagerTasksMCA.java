...
public class VillagerTasksMCA {
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntityMCA>>> getImportantCorePackage(float speedModifier) {
        return ImmutableList.of(
                ...
                Config.getInstance().useSmarterDoorAI ? Pair.of(0, new SmarterOpenDoorsTask()) : Pair.of(0, new OpenDoorsTask()),
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntityMCA>>> getWorkingCorePackage(VillagerProfession profession, float speedModifier) {
        return ImmutableList.of(
                ...
                Pair.of(6, new LazyFindPointOfInterestTask(profession.acquirableWorkstation(), MemoryModuleType.JOB_SITE, MemoryModuleType.POTENTIAL_JOB_SITE, true, Optional.empty())),
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntityMCA>>> getRestPackage(float speed) {
        return ImmutableList.of(
                ...
                Pair.of(3, new ConditionalTask<>(Map.of(MemoryModuleTypeMCA.FORCED_HOME.get(), MemoryModuleState.VALUE_ABSENT),
                        new ExtendedForgetCompletedPointOfInterestTask(registryEntry -> registryEntry.matchesKey(PointOfInterestTypes.HOME), MemoryModuleType.HOME, (entity) -> {
                            // update villagers home/bed position
