...
public class LayeredHair extends SkinListEntry {
    ...
    public static final StreamCodec<ByteBuf, LayeredHair> STREAM_CODEC = StreamCodec.composite(
            Identifier.STREAM_CODEC, LayeredHair::getIdentifierValue,
            GENDER_STREAM_CODEC, LayeredHair::getGender,
            CATEGORY_STREAM_CODEC, LayeredHair::getCategory,
            ByteBufCodecs.FLOAT, LayeredHair::getChance,
            (id, gender, category, chance) -> new LayeredHair(id.toString(), gender, category, chance)
    );
    ...
    public record Definition(Gender gender, Category category, int count, float chance) {
