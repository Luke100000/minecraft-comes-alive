...
public interface ItemsMCA {
    ...
    Item MALE_VILLAGER_SPAWN_EGG = register("male_villager_spawn_egg", new TexturedSpawnEggItem(EntitiesMCA.MALE_VILLAGER, baseProps("male_villager_spawn_egg")));
    Item FEMALE_VILLAGER_SPAWN_EGG = register("female_villager_spawn_egg", new TexturedSpawnEggItem(EntitiesMCA.FEMALE_VILLAGER, baseProps("female_villager_spawn_egg")));

    Item MALE_ZOMBIE_VILLAGER_SPAWN_EGG = register("male_zombie_villager_spawn_egg", new TexturedSpawnEggItem(EntitiesMCA.MALE_ZOMBIE_VILLAGER, baseProps("male_zombie_villager_spawn_egg")));
    Item FEMALE_ZOMBIE_VILLAGER_SPAWN_EGG = register("female_zombie_villager_spawn_egg", new TexturedSpawnEggItem(EntitiesMCA.FEMALE_ZOMBIE_VILLAGER, baseProps("female_zombie_villager_spawn_egg")));

    Item GRIM_REAPER_SPAWN_EGG = register("grim_reaper_spawn_egg", new TexturedSpawnEggItem(EntitiesMCA.GRIM_REAPER, baseProps("grim_reaper_spawn_egg")));

    Item BABY_BOY = register("baby_boy", new BabyItem(Gender.MALE, baseProps("baby_boy").stacksTo(1)));
    Item BABY_GIRL = register("baby_girl", new BabyItem(Gender.FEMALE, baseProps("baby_girl").stacksTo(1)));
    Item SIRBEN_BABY_BOY = register("sirben_baby_boy", new SirbenBabyItem(Gender.MALE, baseProps("sirben_baby_boy").stacksTo(1)));
    Item SIRBEN_BABY_GIRL = register("sirben_baby_girl", new SirbenBabyItem(Gender.FEMALE, baseProps("sirben_baby_girl").stacksTo(1)));
    ...
    Item VILLAGER_TRACKER = register("villager_tracker", new VillagerTrackerItem(baseProps("villager_tracker").stacksTo(1)));

    Item SCYTHE = register("scythe", new ScytheItem(baseProps("scythe")));

    Item BOUQUET = register("bouquet", new BouquetItem(baseProps("bouquet")));

    Item POTION_OF_FEMININITY = register("potion_of_femininity", new PotionOfMetamorphosisItem(baseProps("potion_of_femininity").stacksTo(1), Gender.FEMALE));
    Item POTION_OF_MASCULINITY = register("potion_of_masculinity", new PotionOfMetamorphosisItem(baseProps("potion_of_masculinity").stacksTo(1), Gender.MALE));
    ...
    Item CIVIL_REGISTRY = register("civil_registry", new CivilRegistry(baseProps("civil_registry").stacksTo(1), new CivilRegistryBook("civil_registry", null)
            .setBackground(MCA.locate("textures/gui/books/supporters.png"))));

    Item LETTER = register("letter", new ExtendedWrittenBookItem(baseProps("letter").stacksTo(1), new Book("letter", null)
