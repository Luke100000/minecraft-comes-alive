...
final class BlueprintMapRenderer {
    ...
    RenderResult render(GuiGraphicsExtractor context,
        ...
        renderOutlineBatch(context, structureOutlineLayers, viewport);
        ...
        renderOutlineBatch(context, roomOutlineLayers, viewport);
    ...
    private static void renderConnectorMarkers(GuiGraphicsExtractor context,
        ...
        for (MapConnectorLayer layer : connectorLayers) {
            ...
            Matrix3x2fStack matrices = context.pose();
            matrices.pushMatrix();
            matrices.translate(pos.getX() + 0.5F, pos.getZ() + 0.5F);
            matrices.scale(scale, scale);
            context.centeredText(font, Component.literal(glyph),
    ...
    private static void pushWorldTransform(Matrix3x2fStack matrices, BlueprintMapViewport viewport) {
        matrices.pushMatrix();
        matrices.translate(viewport.centerX(), viewport.centerY());
        matrices.scale(viewport.scale(), viewport.scale());
        matrices.translate((float)-viewport.mapCenterX(), (float)-viewport.mapCenterZ());
    }

    private static void renderRoomRegion(GuiGraphicsExtractor context,
                                         int minX,
                                         int minZ,
                                         int maxInclusiveX,
                                         int maxInclusiveZ,
    ...
    private static void renderRoomFootprint(GuiGraphicsExtractor context,
    ...
    private static void renderStructureShade(GuiGraphicsExtractor context,
    ...
    private static void renderOutlineBatch(GuiGraphicsExtractor context,
    ...
    static void renderCurrentPlayerFace(GuiGraphicsExtractor context,
                                        LocalPlayer player,
                                        int x,
                                        int y,
                                        int size) {
