...
public class VillagerEntityBaseModelMCA extends HumanoidModel<VillagerRenderState> implements CommonVillagerModel<VillagerRenderState> {
    ...
    public void setupAnim(VillagerRenderState state) {
        ...
        if (state.panicAnimationProgress > 0.0F) {
            ...
            this.leftArm.xRot = Mth.lerp(state.panicAnimationProgress, this.leftArm.xRot, armRaise);
            this.leftArm.zRot = Mth.lerp(state.panicAnimationProgress, this.leftArm.zRot, -waveSideways);
            this.rightArm.xRot = Mth.lerp(state.panicAnimationProgress, this.rightArm.xRot, -armRaise);
            this.rightArm.zRot = Mth.lerp(state.panicAnimationProgress, this.rightArm.zRot, waveSideways);
        }
    ...
    @Override
    public void copyPropertiesTo(HumanoidModel<VillagerRenderState> target) {
