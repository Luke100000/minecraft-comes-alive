...
public final class MCALayerDefinitions {
    ...
    public static void register(BiConsumer<ModelLayerLocation, Supplier<LayerDefinition>> register) {
        ...
        register.accept(MCAModelLayers.VILLAGER_CLOTHING,
                () -> LayerDefinition.create(MCAModelGeometry.overlayData(new CubeDeformation(0.0625F), false), 64, 64));
        register.accept(MCAModelLayers.VILLAGER_CLOTHING_SLIM,
                () -> LayerDefinition.create(MCAModelGeometry.overlayData(new CubeDeformation(0.0625F), true), 64, 64));
        register.accept(MCAModelLayers.VILLAGER_HAIR,
                () -> LayerDefinition.create(MCAModelGeometry.hairData(new CubeDeformation(0.125F), false), 64, 64));
        ...
        register.accept(MCAModelLayers.ZOMBIE_VILLAGER_CLOTHING,
                () -> LayerDefinition.create(MCAModelGeometry.overlayData(new CubeDeformation(0.075F), false), 64, 64));
