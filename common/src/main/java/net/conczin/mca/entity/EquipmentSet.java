...
public enum EquipmentSet {
    ...
    GUARD_3(Items.NETHERITE_SWORD, Items.SHIELD, Items.NETHERITE_HELMET, Items.NETHERITE_CHESTPLATE, Items.NETHERITE_LEGGINGS, Items.NETHERITE_BOOTS),
    ...
    ARCHER_3(Items.BOW, Items.AIR, Items.AIR, Items.NETHERITE_CHESTPLATE, Items.DIAMOND_LEGGINGS, Items.DIAMOND_BOOTS),
    ARCHER_3_LEFT(Items.AIR, Items.BOW, Items.AIR, Items.NETHERITE_CHESTPLATE, Items.DIAMOND_LEGGINGS, Items.DIAMOND_BOOTS),
