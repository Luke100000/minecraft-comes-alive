...
public class MCAVillagerTasks {
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super EntityVillagerMCA>>> getWorkPackage(VillagerProfession profession, float speedModifier) {
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super EntityVillagerMCA>>> getPlayPackage(float speedModifier) {
        return ImmutableList.of(
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super EntityVillagerMCA>>> getMeetPackage(VillagerProfession profession, float speedModifier) {
        return ImmutableList.of(
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super EntityVillagerMCA>>> getIdlePackage(VillagerProfession profession, float speedModifier) {
        return ImmutableList.of(
                Pair.of(2, new FirstShuffledTask<>(
                        ImmutableList.of(
                                Pair.of(InteractWithEntityTask.of(EntityType.VILLAGER, 8, MemoryModuleType.INTERACTION_TARGET, speedModifier, 2), 2),
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super EntityVillagerMCA>>> getPanicPackage(VillagerProfession profession, float speedModifier) {
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super EntityVillagerMCA>>> getPreRaidPackage(VillagerProfession profession, float speedModifier) {
        return ImmutableList.of(
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super EntityVillagerMCA>>> getRaidPackage(VillagerProfession profession, float speedModifier) {
        return ImmutableList.of(
                Pair.of(0, new FirstShuffledTask<>(
                        ImmutableList.of(
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super EntityVillagerMCA>>> getHidePackage(VillagerProfession profession, float speedModifier) {
        return ImmutableList.of(
